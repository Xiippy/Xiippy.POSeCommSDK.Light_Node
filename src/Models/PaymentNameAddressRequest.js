...
module.exports =
    class PaymentNameAddressRequest {
        constructor() {
            ...
            this.PaymentRequestAmount = 0.0; // This could be negative for a REFUND!
            this.PaymentRequestCurrency = "";
            this.AllowedCardNetworks =null; // Allowed card networks

            this.PaymentRecordClientAuthenticator = "";
            ...
            this.IncludePhoneNumberInResponse = false;
            this.IncludeNameInResponse = false;
            this.IncludeEmailAddressInResponse = false;
            this.IncludeBillingAddressInResponse = false;
            this.IncludeShippingAddressInResponse = false;
            this.IsViaTerminal = false;

            // New field for scheduled or future payments!
            this.AllowFuturePayments = false;
        }
    }
